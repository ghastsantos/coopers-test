<?php
/**
 * coopers-theme functions and definitions
 *
...
function coopers_theme_setup() {
	/*
		...
		* If you're building a theme based on coopers-theme, use a find and replace
		* to change 'coopers-theme' to the name of your theme in all the template files.
		*/
